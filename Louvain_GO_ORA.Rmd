...
```{r}
# Save the result
write_json(first_louvain_ora_dict, path = "output/Communities/Louvain/first_louvain_ora_dict.json")
```
...
```{r}
# Save the result 
write_json(second_louvain_cluster_ora_dict, path = "output/Communities/Louvain/second_louvain_cluster_ora_dict.json")
```
...
```{r}
# Save the result
write_json(third_louvain_cluster_ora_dict, path = "output/Communities/Louvain/third_louvain_cluster_ora_dict.json")
```
...
```{r}
# Save the result
write_json(first_louvain_ora_dict, path = "output/Communities/Extended/randombipartite_first_louvain_ora_dict.json")
```
...
# Read the JSON file into an R object
first_louvain_cluster_genes <- fromJSON("output/Communities/Extended/randombipartite_second_louvain_cluster_genes.json")
...
```{r}
# Save the result
write_json(first_louvain_ora_dict, path = "output/Communities/Extended/randombipartite_second_louvain_ora_dict.json")
```
...
# Read the JSON file into an R object
first_louvain_cluster_genes <- fromJSON("output/Communities/Extended/randombipartite_third_louvain_cluster_genes.json")
...
```{r}
# Save the result
write_json(first_louvain_ora_dict, path = "output/Communities/Extended/randombipartite_third_louvain_ora_dict.json")
```
...
```{r}
# Save the result
write_json(first_louvain_ora_dict, path = "output/Communities/Extended/hq_first_louvain_ora_dict.json")
```
...
# Read the JSON file into an R object
first_louvain_cluster_genes <- fromJSON("output/Communities/Extended/hq_second_louvain_cluster_genes.json")
...
```{r}
# Save the result
write_json(first_louvain_ora_dict, path = "output/Communities/Extended/hq_second_louvain_ora_dict.json")
```
...
# Read the JSON file into an R object
first_louvain_cluster_genes <- fromJSON("output/Communities/Extended/hq_third_louvain_cluster_genes.json")
...
```{r}
# Save the result
write_json(first_louvain_ora_dict, path = "output/Communities/Extended/hq_third_louvain_ora_dict.json")
```
...
```{r}
# Save the result
write_json(first_louvain_ora_dict, path = "output/Communities/Extended/homomouse_first_louvain_ora_dict.json")
```
...
# Read the JSON file into an R object
first_louvain_cluster_genes <- fromJSON("output/Communities/Extended/homomouse_second_louvain_cluster_genes.json")
...
```{r}
# Save the result
write_json(first_louvain_ora_dict, path = "output/Communities/Extended/homomouse_second_louvain_ora_dict.json")
```
...
# Read the JSON file into an R object
first_louvain_cluster_genes <- fromJSON("output/Communities/Extended/homomouse_third_louvain_cluster_genes.json")
...
```{r}
# Save the result
write_json(first_louvain_ora_dict, path = "output/Communities/Extended/homomouse_third_louvain_ora_dict.json")
```
