...
first_louvain_cluster_genes <- fromJSON("output/Communities/Louvain/random_first_louvain_cluster_genes.json")
...
```{r}
# Save the result
write_json(first_louvain_ora_dict, path = "output/Communities/Louvain/random_first_louvain_ora_dict.json")
```
...
# Read the JSON file into an R object
second_louvain_cluster_genes <- fromJSON("output/Communities/Louvain/random_second_louvain_cluster_genes.json")
...
```{r}
# Save the result 
write_json(second_louvain_cluster_ora_dict, path = "output/Communities/Louvain/random_second_louvain_cluster_ora_dict.json")
```
...
# Read the JSON file into an R object
third_louvain_cluster_genes <- fromJSON("output/Communities/Louvain/random_third_louvain_cluster_genes.json")
...
```{r}
# Save the result
write_json(third_louvain_cluster_ora_dict, path = "output/Communities/Louvain/random_third_louvain_cluster_ora_dict.json")
```
