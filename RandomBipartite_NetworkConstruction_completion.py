...
tot_gene = len(set(tot_gene_random_list))

with open('intermediate/exposure_random_graph_fisher.pickle', 'rb') as handle:
    exposure_random_graph_fisher = pk.load(handle)

unweighted_exp_graph_significant = nx.read_weighted_edgelist("intermediate/unfiltered_weighted_random_exp_graph_significant.edgelist")

unweighted_exp_graph_significant_fisher_pval_dict = {}
for e in unweighted_exp_graph_significant.edges():
    try:
        unweighted_exp_graph_significant_fisher_pval_dict[e] = exposure_random_graph_fisher[e]
    except:
        unweighted_exp_graph_significant_fisher_pval_dict[e] = exposure_random_graph_fisher[e[1],e[0]]
...
nx.write_weighted_edgelist(backbone_exp_graph_significant, "output/backbone_random_exp_graph_significant_weighted.edgelist")